...
// ContextValidate validate this Json response data domain prereg based on the context it is used
func (m *JSONResponseDataDomainPrereg) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *JSONResponseDataDomainPrereg) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JSONResponseDataDomainPrereg) contextValidateMessages(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JSONResponseDataDomainPrereg) contextValidateObject(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JSONResponseDataDomainPrereg) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
