...
// JSONResponseDataObjectUserAssignment Json response data object user assignment
//
...
// Validate validates this Json response data object user assignment
func (m *JSONResponseDataObjectUserAssignment) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *JSONResponseDataObjectUserAssignment) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *JSONResponseDataObjectUserAssignment) UnmarshalBinary(b []byte) error {
	var res JSONResponseDataObjectUserAssignment
