...
// ContextValidate validate this bulk redirect patch request based on the context it is used
func (m *BulkRedirectPatchRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BulkRedirectPatchRequest) contextValidateObjects(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BulkRedirectPatchRequest) contextValidateQuery(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BulkRedirectPatchRequest) contextValidateTemplate(ctx context.Context, formats strfmt.Registry) error {
