...
func NewDeliveryStatus(value DeliveryStatus) *DeliveryStatus {
	return &value
}

// Pointer returns a pointer to a freshly-allocated DeliveryStatus.
func (m DeliveryStatus) Pointer() *DeliveryStatus {
	return &m
}
