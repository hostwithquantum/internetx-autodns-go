...
func NewNameserverActionConstants(value NameserverActionConstants) *NameserverActionConstants {
	return &value
}

// Pointer returns a pointer to a freshly-allocated NameserverActionConstants.
func (m NameserverActionConstants) Pointer() *NameserverActionConstants {
	return &m
}
...
// ContextValidate validates this nameserver action constants based on context it is used
func (m NameserverActionConstants) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
