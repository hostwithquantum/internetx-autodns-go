...
func (m *Notification) validateMessages(formats strfmt.Registry) error {
...
func (m *Notification) contextValidateMessages(ctx context.Context, formats strfmt.Registry) error {
