...
// ContextValidate validate this domain studio source recommended based on the context it is used
func (m *DomainStudioSourceRecommended) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DomainStudioSourceRecommended) contextValidateServices(ctx context.Context, formats strfmt.Registry) error {
