...
// DomainStudioSourceDomainsBot domain studio source domains bot
//
// swagger:model DomainStudioSourceDomainsBot
type DomainStudioSourceDomainsBot struct {
...
// Validate validates this domain studio source domains bot
func (m *DomainStudioSourceDomainsBot) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DomainStudioSourceDomainsBot) validateServices(formats strfmt.Registry) error {
...
// ContextValidate validate this domain studio source domains bot based on the context it is used
func (m *DomainStudioSourceDomainsBot) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DomainStudioSourceDomainsBot) contextValidateServices(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainStudioSourceDomainsBot) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DomainStudioSourceDomainsBot) UnmarshalBinary(b []byte) error {
	var res DomainStudioSourceDomainsBot
