...
func NewAccountingDocumentTypeConstants(value AccountingDocumentTypeConstants) *AccountingDocumentTypeConstants {
	return &value
}

// Pointer returns a pointer to a freshly-allocated AccountingDocumentTypeConstants.
func (m AccountingDocumentTypeConstants) Pointer() *AccountingDocumentTypeConstants {
	return &m
}
...
// ContextValidate validates this accounting document type constants based on context it is used
func (m AccountingDocumentTypeConstants) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
