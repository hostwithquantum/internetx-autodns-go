...
func NewUserProfileFlag(value UserProfileFlag) *UserProfileFlag {
	return &value
}

// Pointer returns a pointer to a freshly-allocated UserProfileFlag.
func (m UserProfileFlag) Pointer() *UserProfileFlag {
	return &m
}
...
// ContextValidate validates this user profile flag based on context it is used
func (m UserProfileFlag) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
