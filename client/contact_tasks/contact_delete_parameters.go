...
ContactDeleteParams contains all the parameters to send to the API endpoint
	...
	for the contact delete operation.
...
// WithDefaults hydrates default values in the contact delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ContactDeleteParams) WithDefaults() *ContactDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the contact delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ContactDeleteParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the contact delete params
func (o *ContactDeleteParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *ContactDeleteParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the contact delete params
func (o *ContactDeleteParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
	o.XDomainrobot2FAToken = xDomainrobot2FAToken
}

// WithXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the contact delete params
func (o *ContactDeleteParams) WithXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) *ContactDeleteParams {
	o.SetXDomainrobotBulkLimit(xDomainrobotBulkLimit)
	return o
}

// SetXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the contact delete params
func (o *ContactDeleteParams) SetXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) {
...
func (o *ContactDeleteParams) WithXDomainrobotContext(xDomainrobotContext *int32) *ContactDeleteParams {
...
func (o *ContactDeleteParams) SetXDomainrobotContext(xDomainrobotContext *int32) {
	o.XDomainrobotContext = xDomainrobotContext
}

// WithXDomainrobotDemo adds the xDomainrobotDemo to the contact delete params
func (o *ContactDeleteParams) WithXDomainrobotDemo(xDomainrobotDemo *bool) *ContactDeleteParams {
	o.SetXDomainrobotDemo(xDomainrobotDemo)
	return o
}

// SetXDomainrobotDemo adds the xDomainrobotDemo to the contact delete params
func (o *ContactDeleteParams) SetXDomainrobotDemo(xDomainrobotDemo *bool) {
	o.XDomainrobotDemo = xDomainrobotDemo
}

// WithXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the contact delete params
func (o *ContactDeleteParams) WithXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) *ContactDeleteParams {
	o.SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin)
	return o
}

// SetXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the contact delete params
func (o *ContactDeleteParams) SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) {
	o.XDomainrobotDomainSafePin = xDomainrobotDomainSafePin
}

// WithXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the contact delete params
func (o *ContactDeleteParams) WithXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) *ContactDeleteParams {
	o.SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan)
	return o
}

// SetXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the contact delete params
func (o *ContactDeleteParams) SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) {
	o.XDomainrobotDomainSafeTan = xDomainrobotDomainSafeTan
}

// WithXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the contact delete params
func (o *ContactDeleteParams) WithXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) *ContactDeleteParams {
	o.SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction)
	return o
}

// SetXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the contact delete params
func (o *ContactDeleteParams) SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) {
	o.XDomainrobotDomainSafeTransaction = xDomainrobotDomainSafeTransaction
}

// WithXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the contact delete params
func (o *ContactDeleteParams) WithXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) *ContactDeleteParams {
	o.SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire)
	return o
}

// SetXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the contact delete params
func (o *ContactDeleteParams) SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) {
...
func (o *ContactDeleteParams) WithXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) *ContactDeleteParams {
...
func (o *ContactDeleteParams) SetXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) {
