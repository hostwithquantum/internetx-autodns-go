...
// New creates a new document tasks API client with basic auth credentials.
...
// New creates a new document tasks API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
type ClientService interface {
	DocumentInfoWithAlias(params *DocumentInfoWithAliasParams, opts ...ClientOption) (*DocumentInfoWithAliasOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
DocumentInfoWithAlias documents info 1901004
...
*/
func (a *Client) DocumentInfoWithAlias(params *DocumentInfoWithAliasParams, opts ...ClientOption) (*DocumentInfoWithAliasOK, error) {
