...
// WithXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) WithXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) *Id4MeIdentityInfoParams {
	o.SetXDomainrobotBulkLimit(xDomainrobotBulkLimit)
	return o
}

// SetXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) SetXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) {
...
func (o *Id4MeIdentityInfoParams) WithXDomainrobotContext(xDomainrobotContext *int32) *Id4MeIdentityInfoParams {
...
func (o *Id4MeIdentityInfoParams) SetXDomainrobotContext(xDomainrobotContext *int32) {
...
func (o *Id4MeIdentityInfoParams) WithXDomainrobotDemo(xDomainrobotDemo *bool) *Id4MeIdentityInfoParams {
	o.SetXDomainrobotDemo(xDomainrobotDemo)
	return o
}

// SetXDomainrobotDemo adds the xDomainrobotDemo to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) SetXDomainrobotDemo(xDomainrobotDemo *bool) {
	o.XDomainrobotDemo = xDomainrobotDemo
}

// WithXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) WithXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) *Id4MeIdentityInfoParams {
	o.SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin)
	return o
}

// SetXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) {
	o.XDomainrobotDomainSafePin = xDomainrobotDomainSafePin
}

// WithXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) WithXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) *Id4MeIdentityInfoParams {
	o.SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan)
	return o
}

// SetXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) {
	o.XDomainrobotDomainSafeTan = xDomainrobotDomainSafeTan
}

// WithXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) WithXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) *Id4MeIdentityInfoParams {
	o.SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction)
	return o
}

// SetXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) {
	o.XDomainrobotDomainSafeTransaction = xDomainrobotDomainSafeTransaction
}

// WithXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) WithXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) *Id4MeIdentityInfoParams {
	o.SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire)
	return o
}

// SetXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the id4 me identity info params
func (o *Id4MeIdentityInfoParams) SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) {
...
func (o *Id4MeIdentityInfoParams) WithXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) *Id4MeIdentityInfoParams {
...
func (o *Id4MeIdentityInfoParams) SetXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) {
