...
CertificateListParams contains all the parameters to send to the API endpoint
	...
	for the certificate list operation.
...
// WithDefaults hydrates default values in the certificate list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CertificateListParams) WithDefaults() *CertificateListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the certificate list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CertificateListParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the certificate list params
func (o *CertificateListParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *CertificateListParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the certificate list params
func (o *CertificateListParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
	o.XDomainrobot2FAToken = xDomainrobot2FAToken
}

// WithXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the certificate list params
func (o *CertificateListParams) WithXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) *CertificateListParams {
	o.SetXDomainrobotBulkLimit(xDomainrobotBulkLimit)
	return o
}

// SetXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the certificate list params
func (o *CertificateListParams) SetXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) {
...
func (o *CertificateListParams) WithXDomainrobotContext(xDomainrobotContext *int32) *CertificateListParams {
...
func (o *CertificateListParams) SetXDomainrobotContext(xDomainrobotContext *int32) {
	o.XDomainrobotContext = xDomainrobotContext
}

// WithXDomainrobotDemo adds the xDomainrobotDemo to the certificate list params
func (o *CertificateListParams) WithXDomainrobotDemo(xDomainrobotDemo *bool) *CertificateListParams {
	o.SetXDomainrobotDemo(xDomainrobotDemo)
	return o
}

// SetXDomainrobotDemo adds the xDomainrobotDemo to the certificate list params
func (o *CertificateListParams) SetXDomainrobotDemo(xDomainrobotDemo *bool) {
	o.XDomainrobotDemo = xDomainrobotDemo
}

// WithXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the certificate list params
func (o *CertificateListParams) WithXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) *CertificateListParams {
	o.SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin)
	return o
}

// SetXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the certificate list params
func (o *CertificateListParams) SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) {
	o.XDomainrobotDomainSafePin = xDomainrobotDomainSafePin
}

// WithXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the certificate list params
func (o *CertificateListParams) WithXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) *CertificateListParams {
	o.SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan)
	return o
}

// SetXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the certificate list params
func (o *CertificateListParams) SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) {
	o.XDomainrobotDomainSafeTan = xDomainrobotDomainSafeTan
}

// WithXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the certificate list params
func (o *CertificateListParams) WithXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) *CertificateListParams {
	o.SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction)
	return o
}

// SetXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the certificate list params
func (o *CertificateListParams) SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) {
	o.XDomainrobotDomainSafeTransaction = xDomainrobotDomainSafeTransaction
}

// WithXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the certificate list params
func (o *CertificateListParams) WithXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) *CertificateListParams {
	o.SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire)
	return o
}

// SetXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the certificate list params
func (o *CertificateListParams) SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) {
...
func (o *CertificateListParams) WithXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) *CertificateListParams {
...
func (o *CertificateListParams) SetXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) {
...
// bindParamCertificateList binds the parameter keys
func (o *CertificateListParams) bindParamKeys(formats strfmt.Registry) []string {
	keysIR := o.Keys
