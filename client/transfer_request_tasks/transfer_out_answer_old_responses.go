...
/*TransferOutAnswerOldOK handles this case with default header values.
...
func (o *TransferOutAnswerOldOK) Error() string {
	return fmt.Sprintf("[PUT /transferout/{domain}/{type}][%d] transferOutAnswerOldOK  %+v", 200, o.Payload)
}
