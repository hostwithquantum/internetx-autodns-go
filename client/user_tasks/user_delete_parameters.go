...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the user delete params
func (o *UserDeleteParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *UserDeleteParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the user delete params
func (o *UserDeleteParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
...
// WithContext adds the context to the user delete params
func (o *UserDeleteParams) WithContext(context int32) *UserDeleteParams {
	o.SetContext(context)
	return o
}

// SetContext adds the context to the user delete params
func (o *UserDeleteParams) SetContext(context int32) {
	o.Context = context
}
