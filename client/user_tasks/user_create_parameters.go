...
type UserCreateParams struct {
	...
	*/
	...
	/* ReplyURL.
	   ...
	   Optional reply url in case of user invite
	*/
	ReplyURL *string
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the user create params
func (o *UserCreateParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *UserCreateParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the user create params
func (o *UserCreateParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
...
// WithReplyURL adds the replyURL to the user create params
func (o *UserCreateParams) WithReplyURL(replyURL *string) *UserCreateParams {
	o.SetReplyURL(replyURL)
	return o
}

// SetReplyURL adds the replyUrl to the user create params
func (o *UserCreateParams) SetReplyURL(replyURL *string) {
	o.ReplyURL = replyURL
}
...
func (o *UserCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ReplyURL != nil {
		...
		// query param replyUrl
		var qrReplyURL string

		if o.ReplyURL != nil {
			qrReplyURL = *o.ReplyURL
		}
		qReplyURL := qrReplyURL
		if qReplyURL != "" {

			if err := r.SetQueryParam("replyUrl", qReplyURL); err != nil {
				return err
			}
		}
	}
