...
NewPasswordVerifyParams contains all the parameters to send to the API endpoint
	...
	for the new password verify operation.
...
// WithDefaults hydrates default values in the new password verify params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *NewPasswordVerifyParams) WithDefaults() *NewPasswordVerifyParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the new password verify params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *NewPasswordVerifyParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the new password verify params
func (o *NewPasswordVerifyParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *NewPasswordVerifyParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the new password verify params
func (o *NewPasswordVerifyParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
