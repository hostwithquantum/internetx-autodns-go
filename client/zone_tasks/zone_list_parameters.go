...
// WithDefaults hydrates default values in the zone list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ZoneListParams) WithDefaults() *ZoneListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the zone list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ZoneListParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the zone list params
func (o *ZoneListParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *ZoneListParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the zone list params
func (o *ZoneListParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
	o.XDomainrobot2FAToken = xDomainrobot2FAToken
}

// WithXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the zone list params
func (o *ZoneListParams) WithXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) *ZoneListParams {
	o.SetXDomainrobotBulkLimit(xDomainrobotBulkLimit)
	return o
}

// SetXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the zone list params
func (o *ZoneListParams) SetXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) {
...
func (o *ZoneListParams) WithXDomainrobotContext(xDomainrobotContext *int32) *ZoneListParams {
	o.SetXDomainrobotContext(xDomainrobotContext)
	return o
}

// SetXDomainrobotContext adds the xDomainrobotContext to the zone list params
func (o *ZoneListParams) SetXDomainrobotContext(xDomainrobotContext *int32) {
	o.XDomainrobotContext = xDomainrobotContext
}

// WithXDomainrobotDemo adds the xDomainrobotDemo to the zone list params
func (o *ZoneListParams) WithXDomainrobotDemo(xDomainrobotDemo *bool) *ZoneListParams {
	o.SetXDomainrobotDemo(xDomainrobotDemo)
	return o
}

// SetXDomainrobotDemo adds the xDomainrobotDemo to the zone list params
func (o *ZoneListParams) SetXDomainrobotDemo(xDomainrobotDemo *bool) {
	o.XDomainrobotDemo = xDomainrobotDemo
}

// WithXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the zone list params
func (o *ZoneListParams) WithXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) *ZoneListParams {
	o.SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin)
	return o
}

// SetXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the zone list params
func (o *ZoneListParams) SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) {
	o.XDomainrobotDomainSafePin = xDomainrobotDomainSafePin
}

// WithXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the zone list params
func (o *ZoneListParams) WithXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) *ZoneListParams {
	o.SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan)
	return o
}

// SetXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the zone list params
func (o *ZoneListParams) SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) {
	o.XDomainrobotDomainSafeTan = xDomainrobotDomainSafeTan
}

// WithXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the zone list params
func (o *ZoneListParams) WithXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) *ZoneListParams {
	o.SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction)
	return o
}

// SetXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the zone list params
func (o *ZoneListParams) SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) {
	o.XDomainrobotDomainSafeTransaction = xDomainrobotDomainSafeTransaction
}

// WithXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the zone list params
func (o *ZoneListParams) WithXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) *ZoneListParams {
	o.SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire)
	return o
}

// SetXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the zone list params
func (o *ZoneListParams) SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) {
...
func (o *ZoneListParams) WithXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) *ZoneListParams {
...
func (o *ZoneListParams) SetXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) {
...
// bindParamZoneList binds the parameter keys
func (o *ZoneListParams) bindParamKeys(formats strfmt.Registry) []string {
	keysIR := o.Keys
