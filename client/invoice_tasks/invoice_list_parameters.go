...
InvoiceListParams contains all the parameters to send to the API endpoint
	...
	for the invoice list operation.
...
// WithDefaults hydrates default values in the invoice list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InvoiceListParams) WithDefaults() *InvoiceListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the invoice list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InvoiceListParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the invoice list params
func (o *InvoiceListParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *InvoiceListParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the invoice list params
func (o *InvoiceListParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
...
// bindParamInvoiceList binds the parameter keys
func (o *InvoiceListParams) bindParamKeys(formats strfmt.Registry) []string {
	keysIR := o.Keys
