...
BackupMxCreateParams contains all the parameters to send to the API endpoint
	...
	for the backup mx create operation.
...
// WithDefaults hydrates default values in the backup mx create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *BackupMxCreateParams) WithDefaults() *BackupMxCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the backup mx create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *BackupMxCreateParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the backup mx create params
func (o *BackupMxCreateParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *BackupMxCreateParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the backup mx create params
func (o *BackupMxCreateParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
	o.XDomainrobot2FAToken = xDomainrobot2FAToken
}

// WithXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the backup mx create params
func (o *BackupMxCreateParams) WithXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) *BackupMxCreateParams {
	o.SetXDomainrobotBulkLimit(xDomainrobotBulkLimit)
	return o
}

// SetXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the backup mx create params
func (o *BackupMxCreateParams) SetXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) {
...
func (o *BackupMxCreateParams) WithXDomainrobotContext(xDomainrobotContext *int32) *BackupMxCreateParams {
...
func (o *BackupMxCreateParams) SetXDomainrobotContext(xDomainrobotContext *int32) {
	o.XDomainrobotContext = xDomainrobotContext
}

// WithXDomainrobotDemo adds the xDomainrobotDemo to the backup mx create params
func (o *BackupMxCreateParams) WithXDomainrobotDemo(xDomainrobotDemo *bool) *BackupMxCreateParams {
	o.SetXDomainrobotDemo(xDomainrobotDemo)
	return o
}

// SetXDomainrobotDemo adds the xDomainrobotDemo to the backup mx create params
func (o *BackupMxCreateParams) SetXDomainrobotDemo(xDomainrobotDemo *bool) {
	o.XDomainrobotDemo = xDomainrobotDemo
}

// WithXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the backup mx create params
func (o *BackupMxCreateParams) WithXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) *BackupMxCreateParams {
	o.SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin)
	return o
}

// SetXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the backup mx create params
func (o *BackupMxCreateParams) SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) {
	o.XDomainrobotDomainSafePin = xDomainrobotDomainSafePin
}

// WithXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the backup mx create params
func (o *BackupMxCreateParams) WithXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) *BackupMxCreateParams {
	o.SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan)
	return o
}

// SetXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the backup mx create params
func (o *BackupMxCreateParams) SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) {
	o.XDomainrobotDomainSafeTan = xDomainrobotDomainSafeTan
}

// WithXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the backup mx create params
func (o *BackupMxCreateParams) WithXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) *BackupMxCreateParams {
	o.SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction)
	return o
}

// SetXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the backup mx create params
func (o *BackupMxCreateParams) SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) {
	o.XDomainrobotDomainSafeTransaction = xDomainrobotDomainSafeTransaction
}

// WithXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the backup mx create params
func (o *BackupMxCreateParams) WithXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) *BackupMxCreateParams {
	o.SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire)
	return o
}

// SetXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the backup mx create params
func (o *BackupMxCreateParams) SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) {
...
func (o *BackupMxCreateParams) WithXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) *BackupMxCreateParams {
...
func (o *BackupMxCreateParams) SetXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) {
...
// bindParamBackupMxCreate binds the parameter keys
func (o *BackupMxCreateParams) bindParamKeys(formats strfmt.Registry) []string {
	keysIR := o.Keys
