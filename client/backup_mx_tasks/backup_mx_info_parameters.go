...
func (o *BackupMxInfoParams) WithXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) *BackupMxInfoParams {
	o.SetXDomainrobotBulkLimit(xDomainrobotBulkLimit)
	return o
}

// SetXDomainrobotBulkLimit adds the xDomainrobotBulkLimit to the backup mx info params
func (o *BackupMxInfoParams) SetXDomainrobotBulkLimit(xDomainrobotBulkLimit *int32) {
...
func (o *BackupMxInfoParams) WithXDomainrobotContext(xDomainrobotContext *int32) *BackupMxInfoParams {
...
func (o *BackupMxInfoParams) SetXDomainrobotContext(xDomainrobotContext *int32) {
	o.XDomainrobotContext = xDomainrobotContext
}

// WithXDomainrobotDemo adds the xDomainrobotDemo to the backup mx info params
func (o *BackupMxInfoParams) WithXDomainrobotDemo(xDomainrobotDemo *bool) *BackupMxInfoParams {
	o.SetXDomainrobotDemo(xDomainrobotDemo)
	return o
}

// SetXDomainrobotDemo adds the xDomainrobotDemo to the backup mx info params
func (o *BackupMxInfoParams) SetXDomainrobotDemo(xDomainrobotDemo *bool) {
	o.XDomainrobotDemo = xDomainrobotDemo
}

// WithXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the backup mx info params
func (o *BackupMxInfoParams) WithXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) *BackupMxInfoParams {
	o.SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin)
	return o
}

// SetXDomainrobotDomainSafePin adds the xDomainrobotDomainSafePin to the backup mx info params
func (o *BackupMxInfoParams) SetXDomainrobotDomainSafePin(xDomainrobotDomainSafePin *string) {
	o.XDomainrobotDomainSafePin = xDomainrobotDomainSafePin
}

// WithXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the backup mx info params
func (o *BackupMxInfoParams) WithXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) *BackupMxInfoParams {
	o.SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan)
	return o
}

// SetXDomainrobotDomainSafeTan adds the xDomainrobotDomainSafeTan to the backup mx info params
func (o *BackupMxInfoParams) SetXDomainrobotDomainSafeTan(xDomainrobotDomainSafeTan *string) {
	o.XDomainrobotDomainSafeTan = xDomainrobotDomainSafeTan
}

// WithXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the backup mx info params
func (o *BackupMxInfoParams) WithXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) *BackupMxInfoParams {
	o.SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction)
	return o
}

// SetXDomainrobotDomainSafeTransaction adds the xDomainrobotDomainSafeTransaction to the backup mx info params
func (o *BackupMxInfoParams) SetXDomainrobotDomainSafeTransaction(xDomainrobotDomainSafeTransaction *string) {
	o.XDomainrobotDomainSafeTransaction = xDomainrobotDomainSafeTransaction
}

// WithXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the backup mx info params
func (o *BackupMxInfoParams) WithXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) *BackupMxInfoParams {
	o.SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire)
	return o
}

// SetXDomainrobotDomainSafeTransactionExpire adds the xDomainrobotDomainSafeTransactionExpire to the backup mx info params
func (o *BackupMxInfoParams) SetXDomainrobotDomainSafeTransactionExpire(xDomainrobotDomainSafeTransactionExpire *strfmt.DateTime) {
...
func (o *BackupMxInfoParams) WithXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) *BackupMxInfoParams {
...
func (o *BackupMxInfoParams) SetXDomainrobotOwnerContext(xDomainrobotOwnerContext *int32) {
