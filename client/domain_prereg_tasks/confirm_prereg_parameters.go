...
ConfirmPreregParams contains all the parameters to send to the API endpoint
	...
	for the confirm prereg operation.
...
// WithDefaults hydrates default values in the confirm prereg params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ConfirmPreregParams) WithDefaults() *ConfirmPreregParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the confirm prereg params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ConfirmPreregParams) SetDefaults() {
