...
JobHistoryInfoParams contains all the parameters to send to the API endpoint
	...
	for the job history info operation.
...
// WithDefaults hydrates default values in the job history info params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobHistoryInfoParams) WithDefaults() *JobHistoryInfoParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job history info params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobHistoryInfoParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the job history info params
func (o *JobHistoryInfoParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *JobHistoryInfoParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the job history info params
func (o *JobHistoryInfoParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
