...
OtpAuthCreateParams contains all the parameters to send to the API endpoint
	...
	for the otp auth create operation.
...
// WithDefaults hydrates default values in the otp auth create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *OtpAuthCreateParams) WithDefaults() *OtpAuthCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the otp auth create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *OtpAuthCreateParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the otp auth create params
func (o *OtpAuthCreateParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *OtpAuthCreateParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the otp auth create params
func (o *OtpAuthCreateParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
