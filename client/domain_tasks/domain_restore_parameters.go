...
DomainRestoreParams contains all the parameters to send to the API endpoint
	...
	for the domain restore operation.
...
// WithDefaults hydrates default values in the domain restore params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DomainRestoreParams) WithDefaults() *DomainRestoreParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the domain restore params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DomainRestoreParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the domain restore params
func (o *DomainRestoreParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *DomainRestoreParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the domain restore params
func (o *DomainRestoreParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
...
// WithReplyTo adds the replyTo to the domain restore params
func (o *DomainRestoreParams) WithReplyTo(replyTo *string) *DomainRestoreParams {
	o.SetReplyTo(replyTo)
	return o
}

// SetReplyTo adds the replyTo to the domain restore params
func (o *DomainRestoreParams) SetReplyTo(replyTo *string) {
	o.ReplyTo = replyTo
}
