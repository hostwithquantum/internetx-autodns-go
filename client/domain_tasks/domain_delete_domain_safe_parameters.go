...
DomainDeleteDomainSafeParams contains all the parameters to send to the API endpoint
	...
	for the domain delete domain safe operation.
...
// WithDefaults hydrates default values in the domain delete domain safe params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DomainDeleteDomainSafeParams) WithDefaults() *DomainDeleteDomainSafeParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the domain delete domain safe params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DomainDeleteDomainSafeParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the domain delete domain safe params
func (o *DomainDeleteDomainSafeParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *DomainDeleteDomainSafeParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the domain delete domain safe params
func (o *DomainDeleteDomainSafeParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
