...
DomainServicesUpdateParams contains all the parameters to send to the API endpoint
	...
	for the domain services update operation.
...
// WithDefaults hydrates default values in the domain services update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DomainServicesUpdateParams) WithDefaults() *DomainServicesUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the domain services update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DomainServicesUpdateParams) SetDefaults() {
...
// WithXDomainrobot2FAToken adds the xDomainrobot2FAToken to the domain services update params
func (o *DomainServicesUpdateParams) WithXDomainrobot2FAToken(xDomainrobot2FAToken *int32) *DomainServicesUpdateParams {
	o.SetXDomainrobot2FAToken(xDomainrobot2FAToken)
	return o
}

// SetXDomainrobot2FAToken adds the xDomainrobot2FAToken to the domain services update params
func (o *DomainServicesUpdateParams) SetXDomainrobot2FAToken(xDomainrobot2FAToken *int32) {
...
// bindParamDomainServicesUpdate binds the parameter keys
func (o *DomainServicesUpdateParams) bindParamKeys(formats strfmt.Registry) []string {
	keysIR := o.Keys
