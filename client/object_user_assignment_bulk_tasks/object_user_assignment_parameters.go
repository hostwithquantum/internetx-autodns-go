...
func (o *ObjectUserAssignmentParams) WithBody(body *models.BulkObjectUserAssignmentPatchRequest) *ObjectUserAssignmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the object user assignment params
func (o *ObjectUserAssignmentParams) SetBody(body *models.BulkObjectUserAssignmentPatchRequest) {
	o.Body = body
}
