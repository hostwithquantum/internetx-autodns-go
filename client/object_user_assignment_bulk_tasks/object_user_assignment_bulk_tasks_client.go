...
// New creates a new object user assignment bulk tasks API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for object user assignment bulk tasks API
*/
type Client struct {
...
/*
  ObjectUserAssignment updates owner objects

  Reassgins objects to a new owner..
*/
